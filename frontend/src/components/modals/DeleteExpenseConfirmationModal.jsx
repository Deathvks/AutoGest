            ...
            <div className="bg-component-bg/80 backdrop-blur-lg rounded-2xl shadow-2xl w-full max-w-md border border-border-color">
                <div className="p-8 text-center">
                    ...
                    <p className="text-text-secondary mt-2">
                        Estás a punto de eliminar permanentemente un gasto de <span className="font-semibold text-text-primary">{new Intl.NumberFormat('es-ES', { style: 'currency', currency: 'EUR' }).format(expense.amount)}</span>.
                    </p>
