...
import { faExclamationTriangle, faFileLines } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in-up">
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-md border border-gray-300 overflow-hidden">
                <div className="p-8 text-center bg-white">
                    ...
                    <h2 className="text-2xl font-extrabold text-gray-900 uppercase tracking-tight">¿Eliminar Archivo?</h2>
                    <p className="text-gray-600 mt-3 text-sm leading-relaxed font-medium">
                        Estás a punto de eliminar permanentemente el archivo:
                    </p>
                    
                    <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200 flex items-center justify-center gap-2" title={file.originalname}>
