...
const SubscriptionSuccessModal = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4 animate-fade-in-up">
            <div className="bg-component-bg/80 backdrop-blur-lg rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden border border-border-color">
                ...
                <div className="flex-shrink-0 mt-auto flex justify-center p-6 border-t border-border-color bg-component-bg-hover/50 rounded-b-2xl">
                    <button 
